...
- Мониторинг параметров:
    ...
    - Процент возврата ошибок HTTP

- Для оценки качества обслуживания клиентов мы можем предложим соглашение об уровне оказания сервиса, в котором прописать ключевые метрики и их допустимые значения. Например, процент ошибку HTTP не более 15%.
