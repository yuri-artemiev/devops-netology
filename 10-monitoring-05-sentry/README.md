...
- Установим Sentry
    - Зайдём веб браузер sentry.io
    - Выберем Get Started
    - Sign up with GitHub
    - Разрешим Sentry доступ к Github
    - Выберем New account
    - Создадим проект Netology

    ![10-05-01.png](10-05-01.png)

- Создадим проект с типом Python
    - Перейдём в проект
    - Выберем Create a sample event
    - Выберем создавшийся issue
    - Выберем Resolve

    ![10-05-02.png](10-05-02.png)
    ![10-05-03.png](10-05-03.png)

- Создадим оповещение
    - Перейдём в Alerts
    - Выберем Create alerts
    - Сохраним настройки Alert
    - Создадим новое Create a sample event
    - Посмотрим уведомление в почте

    ![10-05-04.png](10-05-04.png)